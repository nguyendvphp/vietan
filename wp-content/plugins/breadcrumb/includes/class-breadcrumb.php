		...
		public function breadcrumb_html($themes)
			{
				...
				if(!empty($breadcrumb_text)){
					$html.= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="'.__('Trang chủ','breadcrumb').'" href="#"><span>'.$breadcrumb_text.'</span></a></li>';
					}
				...
				if(is_front_page() && is_home())
					{
						if($breadcrumb_display_home == 'yes')
							{
							$html.= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="'.__('Trang chủ','breadcrumb').'" href="#">Trang chủ</a><span>'.$breadcrumb_separator.'</span></li>';	
							}
				...
				elseif( is_front_page())
					{
						if($breadcrumb_display_home == 'yes')
							{
							$html.= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="'.__('Home','breadcrumb').'" href="#">'.__('Trang chủ','breadcrumb').'</a><span>'.$breadcrumb_separator.'</span></li>';	
							}	
					}	
				...
				elseif( is_home())
				...
				else if(is_attachment())
					{
						...
						if($breadcrumb_display_home == 'yes')
							{
							$html.= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="'.__('Home','breadcrumb').'" href="'.get_bloginfo('url').'">'.__('Trang chủ','breadcrumb').'</a></li>';
							}
