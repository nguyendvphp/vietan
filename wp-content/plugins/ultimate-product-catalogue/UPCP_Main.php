...
function Add_UPCP_FrontEnd_Scripts() {
    ...
    $Catalogue_Style = get_option("UPCP_Catalogue_Style");
    wp_register_script( "jquery", plugins_url( '/js/jquery-1.12.2.min.js' , __FILE__ ), array('jquery') , '1.12.4', true);
    wp_enqueue_script( 'jquery' );
    wp_enqueue_script('jquery-ui-core');
    wp_enqueue_script('jquery-ui-slider');

	wp_enqueue_script('upcp-page-builder', plugins_url( '/js/product-page-display.js' , __FILE__ ), array( 'jquery' ), '', true);
	...
	wp_register_script('upcpjquery', plugins_url( '/js/upcp-jquery-functions.js' , __FILE__ ), array( 'jquery', 'jquery-ui-core', 'jquery-ui-slider' ), '', true);
