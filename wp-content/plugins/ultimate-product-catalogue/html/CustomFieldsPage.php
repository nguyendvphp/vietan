...
<div class="form-field">
	...
	<select name="Field_Control_Type" id="Field_Control_Type">
			<option value='Checkbox'><?php _e("Checkbox", 'UPCP') ?></option>
			<option value='Radio'><?php _e("Radio", 'UPCP') ?></option>
			<option value='Dropdown'><?php _e("Dropdown", 'UPCP') ?></option>
			<option value='Slider'><?php _e("Slider (Only works for integer type fields)", 'UPCP') ?></option>
	</select>
