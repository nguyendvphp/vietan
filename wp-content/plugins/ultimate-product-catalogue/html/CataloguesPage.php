...
<div class="form-field form-required">
	<label for="Catalogue_Name"><?php _e("Name", 'UPCP') ?></label>
	<input name="Catalogue_Name" id="Catalogue_Name" type="text" value="" size="60" />
	<p><?php _e("The name of the catalogue. This is for your own internal use, and to insert the catalogue into a page or post.", 'UPCP') ?></p>
</div>
<div class="form-field">
	<label for="Catalogue_Description"><?php _e("Description", 'UPCP') ?></label>
