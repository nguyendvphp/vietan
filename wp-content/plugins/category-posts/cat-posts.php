		...
		if ( isset( $instance["thumb"] ) && $instance["thumb"] &&
            ...
            if( !(isset( $this->instance['disable_css'] ) && $this->instance['disable_css'])) { 
                if( isset($this->instance['thumb_hover'] )) {
                    $class = "class=\"product-thumb " . $use_css_cropping ." cat-post-" . $instance['thumb_hover'] . "\"";
                } else {
                    $class = "class=\"product-thumb " . $use_css_cropping . "\"";
                }
            } 
			...
			if ($no_link)
				...
				$ret .= '<div class="hit_des thumbbox"><a '.$class . ' href="'.get_the_permalink().'" title="'.the_title_attribute($title_args).'">';
    ...
    function itemHTML($instance,$current_post_id, $post_id) {
        ...
        if( !(isset( $instance['hide_post_titles'] ) && $instance['hide_post_titles'])) { 
			if ($everything_is_link) {
				...
				$ret .= '<div class="hit_des"><a class="post-title';
